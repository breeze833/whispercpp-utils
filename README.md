...
* `systemd/` contains the service files
  ...
  * `stream-stt.service` starts the `stream-stt` program to transcribe speech and inject via HID
* `stream_stt` contains the python utility to transcribe and inject via HID
